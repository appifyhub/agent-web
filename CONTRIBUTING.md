...
You can start by looking through the [list of open issues](https://github.com/appifyhub/agent-web/issues).
...
1. Check the [issues](https://github.com/appifyhub/agent-web/issues) to see if your change was already requested
